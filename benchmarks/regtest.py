...
OVERRIDE_FIELDS = ['time-limit', 'memory-limit', 'skip']
APPEND_FIELDS = ['flags']
...
def process_test(cmd, test, expect, log_file):
  """
...
def main():
  ...
  parser.add_argument("--languages", action="store", default="rust", choices=list(LANGUAGES.keys()),
